...
public class ManagerController {
    ...
    public List<VisitRequest> getCompletedVisits(String storeID) {
        List<VisitRequest> requests = dataModel.getVisitRequest(storeID, Timestamp.valueOf(LocalDate.now().atTime(LocalTime.now())));if(requests != null)
    ...
    public List<VisitRequest> getCurrentVisits(String storeID) {
        List<VisitRequest> requests = dataModel.getVisitRequest(storeID, Timestamp.valueOf(LocalDate.now().atTime(LocalTime.now())));
        if(requests != null)
