...
class CustomerControllerTest {
    ...
    void setUp() {
        ...
        customerController.setDataModel(dataModel);
    ...
    void getCustomerActiveBookings() {
        ...
        for (Booking actBook: customerController.getCustomerActiveBookings("customerTest"))
    ...
    void getCustomerActiveLineups() {
        when(dataModel.getCustomer("customerTest")).thenReturn(customer);
        for (Lineup actLur: customerController.getCustomerActiveLineups("customerTest"))
